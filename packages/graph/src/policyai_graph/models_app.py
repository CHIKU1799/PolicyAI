...
class OrgInvite(Base):
    """An invitation to join an org's team. Created by an org admin; accepted
    either immediately (the invitee already has an auth account) or by the
    signup trigger when the invitee registers with the invited email."""
    ...
    # Stored lowercased so the signup trigger can match case-insensitively.
