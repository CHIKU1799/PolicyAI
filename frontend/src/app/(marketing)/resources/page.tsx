    ...
    <MarketingShell>
      <main className="mx-auto flex max-w-[1304px] flex-col gap-16 px-5 pb-24 pt-12 md:gap-24 md:px-8 md:pt-16">
        ...
        <section id="docs" className="grid scroll-mt-24 gap-4 lg:grid-cols-2">
          {/* Knowledge graph card (dark, links to the landing graph band; the full explorer lives inside the platform). */}
          <Link
            href="/#graph"
          ...
          >
            <div>
              ...
              <p className="mb-0 mt-3 max-w-[52ch] text-[13.5px] leading-relaxed" style={{ color: "#A7ABB4" }}>
                ...
                create: the graph is live on our landing page. Hover a node to isolate its
                neighbourhood; the full explorer with search and hop depth ships inside the platform.
              </p>
            </div>
